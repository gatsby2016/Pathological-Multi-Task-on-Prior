...
class RandomHorizontalFlip(object):
    ...
    def __call__(self, img, mask):
        ...
        Args:
            ...
            mask (PIL Image): mask to be flipped.
...
class RandomVerticalFlip(object):
    ...
    def __call__(self, img, mask):
        ...
        Args:
            img (PIL Image): Image to be flipped.
            mask (PIL Image): mask Image to be flipped.
...
class AutoRandomRotation(object):
    ...
    def __init__(self, degree=None, resample=False, expand=True, center=None, fill=0):
        if degree is None:
            ...
            assert degree in [0, 90, 180, 270], 'degree must in [0, 90, 180, 270]'
            self.degrees = degree
    ...
    def __call__(self, img, mask):
        return F.rotate(img, self.degrees, self.resample, self.expand, self.center, self.fill), F.rotate(mask, self.degrees, self.resample, self.expand, self.center, self.fill)
